defmodule AppCount.Maintenance.InsightReports.UnitVacantReadyProbeTest do
  use AppCount.ProbeCase
  alias AppCount.Maintenance.InsightReports.UnitVacantReadyProbe

  test "insight_item", ~M[  today_range, property] do
    daily_context = ProbeContext.new([], [], property, today_range)

    # When
    insight_item = UnitVacantReadyProbe.insight_item(daily_context)
  ...
  describe "call/1" do
    ...
    test "returns 0 for a property with no units", ~M[builder] do
      ...
      result = UnitVacantReadyProbe.call(unit_tallies)
