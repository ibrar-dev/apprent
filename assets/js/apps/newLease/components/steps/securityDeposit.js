          ...
          <Card>
            <CardBody>
              <div className='form-group'>
                ...
                <Input value={lease.unit_keys || ''} type="number" name="unit_keys" onChange={this.change.bind(this)}/>
              </div>
              <div className='form-group'>
                <Label>Mail Key</Label>
                <Input value={lease.mail_keys || ''} type="number" name="mail_keys" onChange={this.change.bind(this)}/>
              </div>
              <div className='form-group'>
                <Label>Other Key</Label>
                <Input value={lease.other_keys || ''} type="number" name="other_keys" onChange={this.change.bind(this)}/>
              </div>
            </CardBody>
          </Card>
        </Col>
